...
export const FormImputacion = () => {
    
    const { activeDelivery } = useSelector( state => state.mantenimiento );

    const { data: data_estimate, hasError: hasError_estimate, isLoading: isLoading_estimate } = useFetch( `http://localhost:3001/obtenerestimacionentregable/${activeDelivery.id_entregable}` );
    ...
    useEffect(() => {
        ...
        axiosInstance.get(`http://localhost:3001/obtenerimputacionentregable/${activeDelivery.id_entregable}`).then((response) => {
            ...
            <form>
                <Grid2 container spacing={4}>
                    ...
                    <Grid2 size={12}>
                        ...
                        fullWidth
                        name="descripcion"
                        value= { activeDelivery.descripcion_entregable }
                        />
                    </Grid2>
                    ...
                    <Grid2 size={12}>
                        ...
                        value= { activeDelivery.descripcion_ampliada_entregable }
                        />
                    </Grid2>
